...
// q3as #define	MAX_NAME_LENGTH		32		// max length of a client name
#define	MAX_NAME_LENGTH		64		// q3as
...
// q3as #define ColorIndex(c)	( ( (c) - '0' ) & 7 )
#define ColorIndex(c) ( ( (c) - '0' ) )	// q3as
...
// q3as extern vec4_t	g_color_table[8];
extern vec4_t g_color_table[17];	// q3as
...
#define CVAR_BITMAPPED		2048	// q3as; used for detecting cvars set to -1 and resetting it to MAX_QINT
